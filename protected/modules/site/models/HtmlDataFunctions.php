 ...
 *
 */
class HtmlDataFunctions {

    /**
     * Function to Convert all the special chars to simple ..
     * @author cis
     * @todo 
     */
    function convertSpecialSimple($txt) {
    ...
    function replaceTitle($retour) {
        $retour = HtmlDataFunctions::convertSpecialSimple($retour);
